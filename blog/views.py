...
def index(request):
    ...
    popular_posts = posts.order_by("-likes_count").prefetch_related('author')
    ...
    tags = Tag.objects.annotate(related_posts_count=Count('posts'))
    popular_tags = tags.order_by("-related_posts_count")
